...
- Reading content: keep passages in `content/<locale>/reading.json`, validate the schema in code, and author passages per locale instead of translating them at runtime.
